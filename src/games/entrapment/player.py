...
class EntrapmentPlayer(Player, ABC):
    ...
    def print_stats(self):
        num_wins = self.__stats[EntrapmentResult.WIN]
        print(
    ...
    def event_result(self, pos: int, result: EntrapmentResult):
